...
public class PropertyCard extends javax.swing.JFrame {
    ...
    enum Property {
        ...
        //Orange
        ST_JAMES_PLACE (14, 28, 70, 200, 550, 750, 950, 180),
        TENNESSEE_AVE (14, 28, 70, 200, 550, 750, 950, 180),
        NEW_YORK_AVE (16, 32, 80, 220, 600, 800, 1000, 200),
        
        //Red
        KENTUCKY_AVE (18, 36, 90, 250, 700, 875, 1050, 220),
        INDIANA_AVE (18, 36, 90, 250, 700, 875, 1050, 220),
        ILLINOIS_AVE (20, 40, 100, 300, 750, 925, 1100, 240),
        
        //Yellow
        ATLANTIC_AVE (22, 44, 110, 330, 800, 975, 1150, 260),
        VENTOR_AVE (22, 44, 110, 330, 800, 975, 1150, 260),
        MARVIN_GARDENS (24, 48, 120, 360, 850, 1025, 1200, 280),
        
        //Green
        PACIFIC_AVE (26, 52, 130, 390, 900, 1100, 1275, 300),
        NORTH_CAROLINA_AVE (26, 52, 130, 390, 900, 1100, 1275, 300),
        PENNSYLVANIA (28, 56, 150, 450, 1000, 1200, 1400, 320),
